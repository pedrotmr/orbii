  ...
  return (
    ...
    >
      <motion.g
        ...
        animate={live ? { scaleY: [1, 1.08, 0.96, 1.05, 1], scaleX: [1, 0.96, 1.04, 0.98, 1] } : undefined}
        transition={live ? { duration: 1.1, ease: "easeInOut", repeat: Infinity } : undefined}
      >
        <path
      ...
      <motion.g
        ...
        animate={live ? { scale: [1, 1.1, 0.95, 1.06, 1], opacity: [0.9, 1, 0.85, 1, 0.9] } : undefined}
        transition={live ? { duration: 0.85, ease: "easeInOut", repeat: Infinity } : undefined}
      >
        <path
      ...
      <defs>
        <linearGradient id={grad} x1="14" y1="8" x2="34" y2="42" gradientUnits="userSpaceOnUse">
          <stop stopColor="oklch(0.78 0.18 55)" />
          <stop offset="0.55" stopColor="oklch(0.65 0.2 38)" />
          <stop offset="1" stopColor="oklch(0.52 0.18 28)" />
        </linearGradient>
        <linearGradient id={core} x1="20" y1="24" x2="28" y2="42" gradientUnits="userSpaceOnUse">
...
export function OrbitCountIcon() {
  ...
  return (
    <svg viewBox="0 0 48 48" width="48" height="48" fill="none" aria-hidden>
      <circle cx="24" cy="24" r="15" stroke="oklch(0.7 0.05 38 / 0.55)" strokeWidth="1.5" />
      <motion.g
...
export function CapacityIcon({ n }: { n: number }) {
  return (
    <svg viewBox="0 0 48 48" width="48" height="48" fill="none" aria-hidden>
      <circle cx="24" cy="24" r="15" stroke="var(--line-strong)" strokeWidth="1.5" />
...
export function DaysIcon() {
  return (
    <svg viewBox="0 0 48 48" width="48" height="48" fill="none" aria-hidden>
      ...
      <path d="M17 9v5M31 9v5" stroke="var(--ink-soft)" strokeWidth="1.75" strokeLinecap="round" />
    </svg>
  );
}
